...
srun -p med -J sub-026 --mem=8000 -t 12:00:00 -u --pty tcsh -l
...
screen
srun -p med -u -J sub-26 --mem=36000 --nodes=1 -t 12:00:00 --pty tcsh -l
...
# arg1 = surfaces directory for that subject, eg surfaces/sub-026/; arg2 = filename, arg3= epifile to resample to with full path
