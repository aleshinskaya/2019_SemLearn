...
set progDir = `pwd`
 ...
 #names of regressors
#set regressor_labels = ('cause_and_effect_1' 'cause_and_effect_2' 'cause_and_effect_3' 'cause_and_effect_4' 'cause_and_effect_5' 'cause_effect_pastbin5' 'NCM_1' 'NCM_2' 'NCM_3' 'NCM_4' 'NCM_5' 'NCM_pastbin5' 'r1_1' 'r1_2' 'r1_3' 'r1_4' 'r1_5' 'r1_pastbin5' 'r2_1'  'r2_2'  'r2_3'  'r2_4'  'r2_5' 'r2_pastbin5' 'r3_1' 'r3_2' 'r3_3' 'r3_4' 'r3_5' 'r3_pastbin5' 'Probe_cause' 'Probe_effect' 'Probe_oddball' 'Probe_r1' 'Probe_r2' 'Probe_r3' 'Question')
set regressor_labels = ("Drink2"    "Drinnk1"   "Chop1"     "Chop2"     "Grill2"   "Grill1"    "Sautee1"   "Sautee2"   "Dough2"    "Dough1"   "Pour2"     "Pour1"     "Call2"     "Call1"     "Bike2"    "Bike1"     "Read1"     "Read2"     "Basket2"   "Basket1"  "Shave2"    "Shave1"    "Billiard1" "Billard2"  "Brush1"   "Brush2"    "Mow2"      "Mow1"      "Vac2"      "Vac1"     "Mop2"      "Mop1"      "Dish2"     "Dish1")
...
-stim_file 38 $regDir$subjID'_'$sessionID'_task-main_'$runID'_rot_x.1D'\
-stim_label 38 'motion1'\
-stim_base 38\
-stim_file 39 $regDir$subjID'_'$sessionID'_task-main_'$runID'_rot_y.1D'\
-stim_label 39 'motion2' \
-stim_base 39\
-stim_file 40 $regDir$subjID'_'$sessionID'_task-main_'$runID'_rot_z.1D'\
-stim_label 40 'motion3'\
-stim_base 40\
-stim_file 41 $regDir$subjID'_'$sessionID'_task-main_'$runID'_trans_x.1D'\
-stim_label 41 'motion4'\
-stim_base 41\
-stim_file 42 $regDir$subjID'_'$sessionID'_task-main_'$runID'_trans_y.1D'\
-stim_label 42 'motion5' \
-stim_base 42 \
-stim_file 43 $regDir$subjID'_'$sessionID'_task-main_'$runID'_trans_z.1D'\
-stim_label 43 'motion6'\
-stim_base 43\
-stim_file 44 $regDir$subjID'_'$sessionID'_task-main_'$runID'_rot_x_derivative1.1D'\
-stim_label 44 'motion7'\
-stim_base 44\
-stim_file 45 $regDir$subjID'_'$sessionID'_task-main_'$runID'_rot_y_derivative1.1D'\
-stim_label 45 'motion8'\
-stim_base 45\
-stim_file 46 $regDir$subjID'_'$sessionID'_task-main_'$runID'_rot_z_derivative1.1D'\
-stim_label 46 'motion9'\
-stim_base 46\
-stim_file 47 $regDir$subjID'_'$sessionID'_task-main_'$runID'_trans_x_derivative1.1D'\
-stim_label 47 'motion10'\
-stim_base  47\
-stim_file 48 $regDir$subjID'_'$sessionID'_task-main_'$runID'_trans_y_derivative1.1D'\
-stim_label 48 'motion11'\
-stim_base 48\
-stim_file 49 $regDir$subjID'_'$sessionID'_task-main_'$runID'_trans_z_derivative1.1D'\
-stim_label 49 'motion12'\
-stim_base 49\
