...
srun -p med -J sub-025 --mem=8000 -t 12:00:00 -u --pty tcsh -l
...
# SET RUN ORDER!
# [1] 7 8 9 1 2 3 4 5 6 10 11 12 1 2 3 4 5 6
set object_names_list = ('obj7' 'obj8' 'obj9' 'obj1' 'obj2' 'obj3' 'obj4' 'obj5' 'obj6' 'obj10' 'obj11' 'obj12')
...
# arg1 = surfaces directory for that subject, eg surfaces/sub-025/; arg2 = filename, arg3= epifile to resample to with full path
