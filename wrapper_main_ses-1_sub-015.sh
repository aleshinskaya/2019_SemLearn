...
srun -p med -J sub-015 --mem=8000 -t 12:00:00 -u --pty tcsh -l
...
# arg1 = surfaces directory for that subject, eg surfaces/sub-015/; arg2 = filename, arg3= epifile to resample to with full path
