...
srun -p med -J sub-020 --mem=8000 -t 12:00:00 -u --pty tcsh -l
...
set object_names_list = ('obj10' 'obj11' 'obj12' 'obj1' 'obj2' 'obj3' 'obj4' 'obj5' 'obj6'  'obj7' 'obj8' 'obj9')
...
screen
srun -p low -u  --mem=36000 --nodes=1 -t 12:00:00 --pty tcsh -l
...
# arg1 = surfaces directory for that subject, eg surfaces/sub-020/; arg2 = filename, arg3= epifile to resample to with full path
