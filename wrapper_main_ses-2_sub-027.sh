...
dcm2niix_afni -o $subjDir'/anat/' -f $subjID'_'$sessionID'_T1w' -z y $dicomDir'/003'*

#function scans  - main task
# SET SCAN NUMBERS HERE! 
dcm2niix_afni -o $subjDir'/func/' -f $scan1 -z y $dicomDir'/006'*
dcm2niix_afni -o $subjDir'/func/' -f $scan2 -z y $dicomDir'/007'*
dcm2niix_afni -o $subjDir'/func/' -f $scan3 -z y $dicomDir'/008'*
dcm2niix_afni -o $subjDir'/func/' -f $scan4 -z y $dicomDir'/009'*
dcm2niix_afni -o $subjDir'/func/' -f $scan5 -z y $dicomDir'/010'*
dcm2niix_afni -o $subjDir'/func/' -f $scan6 -z y $dicomDir'/011'*
dcm2niix_afni -o $subjDir'/func/' -f $scan7 -z y $dicomDir'/012'*
dcm2niix_afni -o $subjDir'/func/' -f $scan8 -z y $dicomDir'/013'*
dcm2niix_afni -o $subjDir'/func/' -f $scan9 -z y $dicomDir'/014'*
dcm2niix_afni -o $subjDir'/func/' -f $scan10 -z y $dicomDir'/015'*
dcm2niix_afni -o $subjDir'/func/' -f $scan11 -z y $dicomDir'/016'*
dcm2niix_afni -o $subjDir'/func/' -f $scan12 -z y $dicomDir'/017'*
#function scans - localizer 
dcm2niix_afni -o $subjDir'/func/' -f $loc1 -z y $dicomDir'/018'*
