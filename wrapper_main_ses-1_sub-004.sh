...
srun -p med -J sub-004 --mem=8000 -t 12:00:00 -u --pty tcsh -l
...
# SET RUN ORDER!
#
# set object_names_list = ('objx' 'objy' 'objx' 'obj7' 'obj8' 'obj9' 'obj1' 'obj2' 'obj3' 'obj4' 'obj5' 'obj6')
set object_names_list = ('obj10' 'obj11' 'obj12' 'obj4' 'obj5' 'obj6' 'obj1' 'obj2' 'obj3' 'obj7' 'obj8' 'obj9')
...
set loc1 = $subjID'_'$sessionID'_task-loc_run-1_bold' 
...
dcm2niix_afni -o $subjDir'/func/' -f $scan1 -z y $dicomDir'/005'*
dcm2niix_afni -o $subjDir'/func/' -f $scan2 -z y $dicomDir'/006'*
dcm2niix_afni -o $subjDir'/func/' -f $scan3 -z y $dicomDir'/007'*
dcm2niix_afni -o $subjDir'/func/' -f $scan4 -z y $dicomDir'/008'*
dcm2niix_afni -o $subjDir'/func/' -f $scan5 -z y $dicomDir'/009'*
dcm2niix_afni -o $subjDir'/func/' -f $scan6 -z y $dicomDir'/010'*
dcm2niix_afni -o $subjDir'/func/' -f $scan7 -z y $dicomDir'/011'*
dcm2niix_afni -o $subjDir'/func/' -f $scan8 -z y $dicomDir'/012'*
dcm2niix_afni -o $subjDir'/func/' -f $scan9 -z y $dicomDir'/013'*
dcm2niix_afni -o $subjDir'/func/' -f $scan10 -z y $dicomDir'/014'*
dcm2niix_afni -o $subjDir'/func/' -f $scan11 -z y $dicomDir'/015'*
dcm2niix_afni -o $subjDir'/func/' -f $scan12 -z y $dicomDir'/016'*
#function scans - localizer 
dcm2niix_afni -o $subjDir'/func/' -f $loc1 -z y $dicomDir'/017'*
#field map  (reverse-AP)
dcm2niix_afni -o $subjDir'/fmap/' -f $fmapName -z y $dicomDir'/019'*
...
matlab -nodisplay -r "objects=[1:6]; volume_searchlight_associativeCoding('$subjID',objects,'$topDir'); exit"
matlab -nodisplay -r "volume_searchlight_relationalCat('$subjID','$topDir'); exit"
matlab -nodisplay -r "volume_searchlight_relCat_alltrials('$subjID','$topDir');exit"
matlab -nodisplay -r "volume_searchlight_frequencyCat('$subjID','$topDir'); exit"
matlab -nodisplay -r  "volume_searchlight_visualSim('$subjID','$topDir'); exit"


: #call t-test over the runs 
# (subjID,runNames,homepath,whichData)
matlab -nodisplay -r "volume_ttest_runs('$subjID',[1:6],'$topDir',1); exit"
...
./create_subj_volume_parcellation.sh -L $subjID.txt -a HCPMMP1 -d glasser_roi -m YES -D $surfDirAll
...
# arg1 = surfaces directory for that subject, eg surfaces/sub-004/; arg2 = filename, arg3= epifile to resample to with full path
