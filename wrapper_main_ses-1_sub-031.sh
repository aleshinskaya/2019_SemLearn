...
srun -p med -J sub-031 --mem=8000 -t 12:00:00 -u --pty tcsh -l
...
# SET RUN ORDER!
# [1] 4 5 6 10 11 12 1 2 3 7 8 9 
set object_names_list = ('obj4' 'obj5' 'obj6' 'obj10' 'obj11' 'obj12' 'obj1' 'obj2' 'obj3' 'obj7' 'obj8' 'obj9')
...
dcm2niix_afni -o $subjDir'/fmap/' -f $fmapName -z y $dicomDir'/018'*
...
screen
srun -p med -u -J sub-31 --mem=36000 --nodes=1 -t 12:00:00 --pty tcsh -l
...
singularity run --cleanenv /share/apps/fmriprep-1.4.1/fmriprep.simg $fmriPrepDir'/input/' $fmriPrepDir'/output/' participant  --fs-license-file $rootDir'/templates/license.txt' --participant_label $subjID -w $fmriPrepDir'/working/' -vv --output-spaces 'MNI152NLin2009cAsym' anat --fs-no-reconall  --nthreads 2 --mem_mb 20000 --ignore fieldmaps --n_cpus 8
exit 
...
# arg1 = surfaces directory for that subject, eg surfaces/sub-031/; arg2 = filename, arg3= epifile to resample to with full path
